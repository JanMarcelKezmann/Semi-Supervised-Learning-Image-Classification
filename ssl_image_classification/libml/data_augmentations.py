...
@tf.function
def weak_augment(x, height, width, pad=4, seed=None):
	"""
...
@tf.function
def medium_augment(x, height, width, pad=4, seed=None):
	"""
	Function that applies weak augmentation on batch of given images.
...
@tf.function
def strong_augment(x, height, width, pad=4, rand_jpeg_quality=False, seed=None):
	"""
	Function that applies weak augmentation on batch of given images.
